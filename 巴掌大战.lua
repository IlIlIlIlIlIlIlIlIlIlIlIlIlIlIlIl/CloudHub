local Library = loadstring(game:HttpGet("https://pastebin.com/raw/N4M1tsG3"))()

local Window = Library:Window("云中心", "巴掌大战")
...
Player:Toggle("自动捡糖果", false, function(Value)
CandyCornFarm = Value
